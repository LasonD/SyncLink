...
namespace SyncLink.Infrastructure.Migrations
{
    ...
    [Migration("20230618202031_Adjust-Whiteboards2")]
    partial class AdjustWhiteboards2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Features.WhiteboardElement", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Feed.QuizOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Feed.Vote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Feed.Voting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Feed.VotingOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Feed.WordPhraseOfDayDiscussion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Feed.WordsQuiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.GroupJoinRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Rooms.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Rooms.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Rooms.UserRoom", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.UserGroup", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Features.TextPlotGame.TextPlotGame", b =>
                {
                    ...
                    b.HasOne("SyncLink.Application.Domain.Groups.Group", "Group")
                        .WithMany()
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Features.WhiteboardElement", b =>
                {
                    ...
                    b.HasOne("SyncLink.Application.Domain.Features.Whiteboard", "Whiteboard")
                        .WithMany("WhiteboardElements")
                        .HasForeignKey("WhiteboardId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.OwnsOne("SyncLink.Application.Domain.Features.WhiteboardElementOptions", "Options", b1 =>
                        {
                            ...
                            b1.Property<float?>("Cx")
                                .HasColumnType("real");

                            b1.Property<float?>("Cy")
                                .HasColumnType("real");

                            b1.Property<string>("DashArray")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<float?>("DashOffset")
                                .HasColumnType("real");

                            b1.Property<string>("Fill")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("FontFamily")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<float?>("FontSize")
                                .HasColumnType("real");

                            b1.Property<string>("FontStyle")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("FontWeight")
                                .HasColumnType("nvarchar(max)");
                            ...
                            b1.Property<int>("LineCap")
                                .HasColumnType("int");

                            b1.Property<int>("LineJoin")
                                .HasColumnType("int");

                            b1.Property<float?>("Rx")
                                .HasColumnType("real");

                            b1.Property<float?>("Ry")
                                .HasColumnType("real");

                            b1.Property<string>("StrokeColor")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<float?>("StrokeWidth")
                                .HasColumnType("real");
                            ...
                            b1.Property<float?>("X1")
                                .HasColumnType("real");

                            b1.Property<float?>("X2")
                                .HasColumnType("real");

                            b1.Property<float?>("Y1")
                                .HasColumnType("real");

                            b1.Property<float?>("Y2")
                                .HasColumnType("real");

                            b1.HasKey("WhiteboardElementId");
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Feed.QuizOption", b =>
                {
                    b.HasOne("SyncLink.Application.Domain.Groups.Feed.WordsQuiz", null)
                        .WithMany("Options")
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Feed.Vote", b =>
                {
                    ...
                    b.HasOne("SyncLink.Application.Domain.Groups.Feed.VotingOption", null)
                        .WithMany("Votes")
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Feed.VotingOption", b =>
                {
                    b.HasOne("SyncLink.Application.Domain.Groups.Feed.Voting", "Voting")
            ...
            modelBuilder.Entity("SyncLink.Application.Domain.Groups.Rooms.Message", b =>
                {
                    b.HasOne("SyncLink.Application.Domain.Groups.Rooms.Room", "Room")
                        .WithMany("Messages")
